...
import com.fendrixx.aurus.api.AurusAPIImpl;
import com.fendrixx.aurus.api.AurusProvider;
...
public class Aurus extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        AurusProvider.set(new AurusAPIImpl(this));
    ...
    private void sendStartupMessage() {
        ...
        Bukkit.getConsoleSender().sendMessage(ColorUtils.format("""
                ...
                <gradient:dark_purple:yellow>| ░█▄▄█░█ ░█ █▀▀█░█ ░█░██▀▀</gradient>
                <gradient:dark_purple:yellow>| ░█ ░█░█▄▄█ █▀█▄░█▄▄█ ▄▄█▀</gradient>
                <dark_purple>|<gradient:dark_gray:white> - Aurus 1.0.0 by Fendrixx
                \s
                """));
    }
